...
class IQ(IQCSmell):
    ...
    def get_result(self, matrix):
        ...
        Conta il numero massimo di operazioni tra l’inizializzazione di un qubit e il suo primo utilizzo. 
        Ignora le operazioni di tipo “barrier”. 
        Restituisce il valore massimo trovato tra tutte le operazioni tra l’inizializzazione e il primo utilizzo del qubit. 
        """
